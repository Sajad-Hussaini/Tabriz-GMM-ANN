...
def main():
    ...
    mw = col_mw.number_input('**Magnitude** (Mw)', min_value=0.0, max_value=10.0, value=7.0, step=0.1, help="Magnitude of the earthquake")
    ...
    try:
        ...
        st.error(str(ve))
    st.markdown("Developed by [S.M. Sajad Hussaini](linkedin.com/in/sajadhussaini)")
